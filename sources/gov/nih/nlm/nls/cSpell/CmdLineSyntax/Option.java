package gov.nih.nlm.nls.cSpell.CmdLineSyntax;
import java.util.*;
...
public class Option
{
    ...
    *
    * @param optionStr the option in string format
    */
    ...
    *
    * @param optionList the option in collection format - list
    */
    ...
    * 
    * @return  the option object from arguments
    */
    ...
    *
    * @return  A Vector of OptionItem - all option itmes of this option
    *
    * @see OptionItem
    */
    ...
    *
    * @return  A Vector of String - all option items in the String format
    */
    ...
    */
    ...
    public final static char ARGUMENT_SEP = '+';
    ...
    public final static String BOOLEAN_ARGUMENT = "BLN";
    /** an abbreviation of a String argument in an option */
    public final static String STRING_ARGUMENT = "STR";
    /** an abbreviation of an int argument in an option */
    public final static String INT_ARGUMENT = "INT";
    /** an abbreviation of a long argument in an option */
    public final static String LONG_ARGUMENT = "LONG";
    /** an abbreviation of a float argument in an option */
    public final static String FLOAT_ARGUMENT = "FLT";
    // private data 
    private String[] parentStr_ = {"", "", "", "", ""};  // private use
