...
public class ProcRealWordMerge
{
    ...
    */
        ...
        CSpellApi cSpellApi, boolean debugFlag)
    {
        ...
        while(index < inTokenList.size())
        {
            ...
            if(curTokenObj.IsSpaceToken() == false)
            {
                ...
                MergeObj mergeObj = RealWordMergeCorrector.GetCorrectTerm(
        ...
        ArrayList<TokenObj> outTokenList = 
            MergeCorrector.CorrectTokenListByMerge(inTokenList, mergeObjList,
            TokenObj.HIST_RW_M, debugFlag, cSpellApi);
        return outTokenList;
    }
    ...
    // data member
    private static final String INFO_M = "MERGE";
}
